...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        core_org  = orm['core.Organisation']
        popit_org = orm['popit.Organisation']
        
        original_core_id = orm['popit.CodeType'].objects.get(type='original_core_id')

        # go through all orgs and copy across to new tables
        for old in core_org.objects.all():

            # create the new org
            new = popit_org.objects.create(
                slug    = slugify(old.name)[0:50],
                summary = old.summary,
                started = old.started,
                ended   = old.ended,
            )
            ...
            # Save the old id in the code types
            new.codes.create(
                organisation = new,
            ...
            org_content_type = orm['contenttypes.ContentType'].objects.get(app_label='core', model='organisation')
            contacts = orm['core.Contact'].objects.filter(content_type=org_content_type).filter(object_id=old.id)

            for contact in contacts:
                data_key, created = orm['popit.OrganisationDataKey'].objects.get_or_create(
                    name = contact.kind.name
                )

                orm['popit.OrganisationData'].objects.create(
                    organisation = new,
                    key          = data_key,
                    value        = contact.value,
                )
    ...
    def backwards(self, orm):
        "Delete all the organisations in popit"
        orm['popit.Organisation'].objects.all().delete()
    ...
    models = {
        ...
        'core.contact': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 13, 14, 46, 41, 417326)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 13, 14, 46, 41, 417359)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'scorecards.category': {
            ...
            '_description_rendered': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 13, 14, 46, 41, 404671)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 13, 14, 46, 41, 404731)', 'auto_now': 'True', 'blank': 'True'})
        },
        'scorecards.entry': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 13, 14, 46, 41, 405464)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 13, 14, 46, 41, 405492)', 'auto_now': 'True', 'blank': 'True'})
        }
    }
